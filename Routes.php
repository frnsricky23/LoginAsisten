...
// lATIHAN 3
$routes->get('ktp', 'Ktp::index');
$routes->get('ktp/ktm', 'Ktp::indexKTM');



// Latihan 4
$routes->get('input-data', 'lulus::index');
$routes->post('siswa/process_data', 'lulus::process_data');

// LATIHAN CODEIGNITER 2
$routes->get('login', 'Login::index');

$routes->get('asisten', 'AsistenController::index');
$routes->get('login', 'Login::index');

//Teori Simpan Asisten
